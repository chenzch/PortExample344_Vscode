...
INCLUDE_DIRS := $(INCLUDE_DIRS) $(PLUGINS_DIR)/Platform_$(AR_PKG_NAME)/startup/include
endif
...
SOURCE_FILES := $(SOURCE_FILES) $(foreach file,$(RTE_FILES_WITH_PATH),$(file:$(PLUGINS_DIR)/Rte_$(AR_PKG_NAME)/src/%=%))
INCLUDE_DIRS := $(INCLUDE_DIRS) $(PLUGINS_DIR)/Rte_$(AR_PKG_NAME)/include
endif
